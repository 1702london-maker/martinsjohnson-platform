...
const FILTERS = ['All', 'Oxford', 'Derby', 'Brogue', 'Boot', 'Loafer', 'Monk']
      ...
      <div style={{ background: '#EBEBEA', borderBottom: '1px solid #D8D6D0' }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p style={{ color: '#5A5A58', maxWidth: '480px', lineHeight: 1.8 }}>
            Handcrafted footwear and leather goods for the modern gentleman. Each piece built to outlast trends.
          </p>
        </div>
      </div>
