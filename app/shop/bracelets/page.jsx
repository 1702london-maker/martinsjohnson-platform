...
export const metadata = {
  title: 'Bracelets | Martins Johnson',
  description: 'Leather and sterling silver wrist pieces. Minimal, purposeful, and handfinished.',
}

const FILTERS = ['All', 'Leather', 'Silver', 'Braided', 'Cuff']
      ...
      <div style={{ background: '#EBEBEA', borderBottom: '1px solid #D8D6D0' }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p style={{ color: '#5A5A58', maxWidth: '480px', lineHeight: 1.8 }}>
            Leather and sterling silver wrist pieces. Minimal, purposeful, and handfinished.
          </p>
        </div>
      </div>
