...
export const metadata = {
  title: 'Leather Goods | Martins Johnson',
  description: 'The complete leather goods range — wallets, card holders, key fobs, and small accessories.',
}

const FILTERS = ['All', 'Wallet', 'Card Holder', 'Key Fob', 'Passport']
...
export default async function Page({ searchParams }) {
  const products = await getProducts('leather-goods')
      ...
      <div style={{ background: '#EBEBEA', borderBottom: '1px solid #D8D6D0' }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p style={{ color: '#5A5A58', maxWidth: '480px', lineHeight: 1.8 }}>
            The complete leather goods range — wallets, card holders, key fobs, and small accessories.
          </p>
        </div>
      </div>
