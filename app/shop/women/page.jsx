...
export const metadata = {
  title: 'Women's Collection | Martins Johnson',
  description: 'From sculptural heels to refined flats — luxury footwear engineered around the female form.',
}

const FILTERS = ['All', 'Heel', 'Flat', 'Pump', 'Boot', 'Mule', 'Loafer']
      ...
      <div style={{ background: '#EBEBEA', borderBottom: '1px solid #D8D6D0' }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p style={{ color: '#5A5A58', maxWidth: '480px', lineHeight: 1.8 }}>
            From sculptural heels to refined flats — luxury footwear engineered around the female form.
          </p>
        </div>
      </div>
