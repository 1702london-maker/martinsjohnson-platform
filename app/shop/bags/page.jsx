...
export const metadata = {
  title: 'Bags | Martins Johnson',
  description: 'Structured, intentional, and built to last a lifetime. Full-grain leather bags with brass hardware.',
}

const FILTERS = ['All', 'Briefcase', 'Holdall', 'Tote', 'Clutch', 'Shoulder']
...
export default async function Page({ searchParams }) {
  const products = await getProducts('bags')
    ...
    <div style={{ paddingTop: '5rem', background: '#F3F1EC', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#EBEBEA', borderBottom: '1px solid #D8D6D0' }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <p className="eyebrow mb-3">Carry Pieces</p>
          ...
          <p style={{ color: '#5A5A58', maxWidth: '480px', lineHeight: 1.8 }}>
            Structured, intentional, and built to last a lifetime. Full-grain leather bags with brass hardware.
          </p>
        </div>
      </div>
