...
export const metadata = {
  title: 'Capsule Drops | Martins Johnson',
}

const ITEMS = [{'name': 'Drop 001 — Obsidian', 'sub': '6 pieces remaining', 'price': 1850, 'tag': 'Limited'}, {'name': 'Drop 002 — Cognac Edit', 'sub': 'Sold out', 'price': 1650, 'tag': 'Sold Out'}, {'name': 'Drop 003 — Ivory Noir', 'sub': '12 pieces remaining', 'price': 2100, 'tag': 'New'}]
    ...
    <div style={{ paddingTop: '5rem', background: '#F3F1EC', minHeight: '100vh' }}>
      <div style={{ background: bg }} className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <p className="eyebrow mb-3" style={{ color: mutedCol }}>Limited Edition</p>
          ...
          <p style={{ color: mutedCol, maxWidth: '480px', lineHeight: 1.8 }}>
            Seasonal drops that will not be restocked. Once gone, they are gone.
          </p>
        </div>
      </div>
